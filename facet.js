...
/**
* @param {Stone} stone
* @param {Array<any>} lines_in
* @param {Uint8Array} roll_in
* @param {number} precision
* @returns {Float64Array}
*/
export function expectimaxWasm(stone, lines_in, roll_in, precision) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(stone, Stone);
        var ptr0 = stone.__destroy_into_raw();
        wasm.expectimaxWasm(retptr, ptr0, addHeapObject(lines_in), addHeapObject(roll_in), precision);
...
export class Stone {
    ...
    */
    constructor(chance, line_0, line_1, line_2, roll_0, roll_1, roll_2) {
        const ret = wasm.stone_new_wasm(chance, line_0, line_1, line_2, roll_0, roll_1, roll_2);
